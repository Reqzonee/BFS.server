...
router.get("/store-configs/:storeId/menu", authMiddleware(["ADMIN", "EMPLOYEE", "STORE_ADMIN", "POS"]), getStoreMenu);
router.get("/store-configs/:storeId/addons", authMiddleware(["ADMIN", "EMPLOYEE", "STORE_ADMIN", "POS"]), getStoreAddOns);
...
// Toggle favorite status for a store item
// /store-configs/toggle-favorite
router.post("/store-configs/toggle-favorite", authMiddleware(["ADMIN", "EMPLOYEE", "POS"]), toggleStoreFavorite);
