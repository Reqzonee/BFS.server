...
const createMenuMaster = async (req, res) => {
  try {
    const {
      menuName,
      menuGroup,
...
const getAllMenuMasters = async (req, res) => {
  try {
...
const getMenuMasterById = async (req, res) => {
  try {
    const { menuMasterId } = req.params;
    const menuMaster =
...
const listMenuMasterByParams = async (req, res) => {
  try {
...
const getMenuByGroups = async (req, res) => {
  try {
...
const getMenuTest = async (req, res) => {
  try {
