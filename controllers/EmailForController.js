...
exports.createEmailFor = async (req, res) => {
  try {
...
exports.updateEmailFor = async (req, res) => {
  try {
...
exports.getEmailForById = async (req, res) => {
  try {
    const { emailForId } = req.params;
...
exports.listAllEmailFor = async (req, res) => {
  try {
...
exports.deleteEmailFor = async (req, res) => {
  try {
    const { emailForId } = req.params;
...
exports.listEmailForByParams = async (req, res) => {
  try {
